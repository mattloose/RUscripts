...
getmodels.py - Script for accessing model files.
...
ReadUntil - this folder contains the live read until scripts. It also includes a file 'ruutils.py'. This is required by many of the other scripts within the collection.
